Ext.define('Admin.view.main.MainController', {
    ...
    openAddWindow:function(grid, rowIndex, colIndex){
        var win = grid.up('container').add(Ext.widget('edit')).show();
    },
    ...
    // onModifiedPassword:function(grid, rowIndex, colIndex){
    //     var win = grid.up('container').add(Ext.widget('modified')).show();
    // },
    // onLoginOut: function() {
